        ...
        if ($role_id === 1) { // Пользователь с ролью 1 (админ)
            ...
            <ul style="list-style-type: none; padding: 0;">
                ...
                <li><a href="<?= app()->route->getUrl('/count_total_area_by_institution') ?>">Подсчёт общей площади учебных
                        аудиторий по уч заведению</a></li>
                <li><a href="<?= app()->route->getUrl('/count_total_area_by_buildings') ?>">Подсчёт общей площади учебных
                        аудиторий по зданиям</a></li>
            </ul>
            <?php
            ...
            <ul style="list-style-type: none; padding: 0;">
                ...
                <li><a href="<?= app()->route->getUrl('/count_total_area_by_buildings') ?>">Подсчёт общей площади учебных
                        аудиторий по зданиям</a></li>
                <li><a href="<?= app()->route->getUrl('/select_room_numbers_by_buildings') ?>">Выбор номера помещений по
                        зданиям</a></li>
            </ul>
            <?php
        }
