...
<body>
<h2 style="font-size: x-small">Добавление нового здания</h2>
<h3><?= $message ?? ''; ?></h3>
<form method="post" style="display: flex; gap: 20px; flex-direction: column; width: 800px"  method="post">
    ...
    <label><input type="text" name="login" placeholder="Адрес" style="background: rgba(236, 236, 236, 1);border: none;height: 22px;font-weight: 600;"></label>
